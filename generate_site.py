...
#buy .buy-card{
  width: 100%;
  max-width: 560px; /* 520/480 に下げるとさらに短くできます */
}
...
@media (min-width: 900px){
  #buy .buy-notes.panel{
    width: 85.3%;
    margin: -8px 10% 0 0; /* 上-8 / 右10% / 下0 / 左0 */
  }
}
...
/* =========================
   BUY（郵送買取） SPレイアウト（～900px）
========================= */
@media (max-width: 900px){
  /* スマホは縦積み（表 → mail_buy → yusoudragon → 注意事項） */
  #buy .buy-layout{
    display: grid;
  ...
  #buy .buy-table{
    ...
    border-spacing: 0 4px !important; /* 0 8px → 0 4px */
  }

  /* ★テーブル内だけ 30:70（左ラベルを狭く、右本文を広く） */
  #buy .buy-table th{
    width: 28% !important;
    white-space: nowrap;
    padding-right: 8px;
  ...
  /* yusoudragon：見切れゼロ（contain）※画像・レイアウト位置は不変 */
  #buy .buy-cta-link{
    background: #fff; /* レターボックス色 */
  }
  #buy .buy-cta-img{
